 ...
 */
{
   ...
   void BI_cMPI_amx(void *, void *, int *, BI_MPI_Datatype *);
   void BI_cMPI_amx2(void *, void *, int *, BI_MPI_Datatype *);
/*
 ...
 */
      ...
      bp->N = bp2->N = N;
      bp->dtype = bp2->dtype = BI_MPI_COMPLEX;
   }
   ...
   case ' ':         /* use MPI's reduction by default */
      ...
      if (Mpval(ldia) == -1)
      {
         BI_MPI_Op_create(BI_cMPI_amx2, i, &BlacComb, ierr);
      }
      else
      {
         BI_MPI_Op_create(BI_cMPI_amx, i, &BlacComb, ierr);
