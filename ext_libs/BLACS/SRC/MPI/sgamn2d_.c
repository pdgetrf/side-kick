 ...
 */
{
   ...
   void BI_sMPI_amn(void *, void *, int *, BI_MPI_Datatype *);
   void BI_sMPI_amn2(void *, void *, int *, BI_MPI_Datatype *);
/*
 ...
 */
      ...
      bp->N = bp2->N = N;
      bp->dtype = bp2->dtype = BI_MPI_FLOAT;
   }
   ...
   case ' ':         /* use MPI's reduction by default */
      ...
      if (Mpval(ldia) == -1)
      {
         BI_MPI_Op_create(BI_sMPI_amn2, i, &BlacComb, ierr);
      }
      else
      {
         BI_MPI_Op_create(BI_sMPI_amn, i, &BlacComb, ierr);
