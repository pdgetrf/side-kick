 ...
 */
{
   ...
   void BI_zMPI_amn(void *, void *, int *, BI_MPI_Datatype *);
   void BI_zMPI_amn2(void *, void *, int *, BI_MPI_Datatype *);
/*
 ...
 */
      ...
      disp[0] = 0;
      disp[1] = idist;
      dtypes[0] = BI_MPI_DOUBLE_COMPLEX;
 ...
 */
      ...
      bp->N = bp2->N = N;
      bp->dtype = bp2->dtype = BI_MPI_DOUBLE_COMPLEX;
   }
   ...
   case ' ':         /* use MPI's reduction by default */
      ...
      if (Mpval(ldia) == -1)
      {
         BI_MPI_Op_create(BI_zMPI_amn2, i, &BlacComb, ierr);
      }
      else
      {
         BI_MPI_Op_create(BI_zMPI_amn, i, &BlacComb, ierr);
