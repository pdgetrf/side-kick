...
*  ====================================================================
*     .. External Functions ..
      INTEGER  CMMD_SELF_ADDRESS
      EXTERNAL CMMD_SELF_ADDRESS
*     ..
*     .. Executable Statements ..
*
      IBTMYPROC = CMMD_SELF_ADDRESS()
      RETURN
*
*     End of IBTMYPROC
*
...
*     .. External Functions ..
      ...
      EXTERNAL CMMD_PARTITION_SIZE
*     ..
*     .. Executable Statements ..
*
      IBTNPROCS = CMMD_PARTITION_SIZE()
*
      RETURN
*
*     End of IBTNPROCS
...
*
      IF(DEST .EQ. -1)  THEN
         ...
         DO 10 I = 0, IBTNPROCS()-1
            IF( I .NE. IAM )
     $         CALL CMMD_SEND_BLOCK(I, MSGID, BUFF, LENGTH)
   10    CONTINUE
      ELSE
         CALL CMMD_SEND_BLOCK(DEST, MSGID, BUFF, LENGTH)
      END IF
*
      RETURN
*
...
*     Receive the message
*
      CALL CMMD_RECEIVE_BLOCK(SRC, MSGID, BUFF, LENGTH)
*
      RETURN
*
*     End of BTRECV
